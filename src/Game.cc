...
Game::Game()
{
  ...
  //Pared = new GameObject(ASSETS_TILES, 4.f, 20, 35, 0, 0, 13, 640, b2BodyType::b2_staticBody, world, window);
  //Pared->SetTagName("Pared");
  //Pared1 = new GameObject(ASSETS_TILES, 4.f, 20, 35, 0, 0, 13, 560, b2BodyType::b2_staticBody, world, window);
  //Pared1->SetTagName("Pared");
  //Pared2 = new GameObject(ASSETS_TILES, 4.f, 20, 35, 0, 0, 13, 480, b2BodyType::b2_staticBody, world, window);
  //Pared2->SetTagName("Pared");
...
void Game::Start()
{
  ...
  AddGameObject(Piso8);
  //AddGameObject(Pared);
  //AddGameObject(Pared1);
  //AddGameObject(Pared2);
